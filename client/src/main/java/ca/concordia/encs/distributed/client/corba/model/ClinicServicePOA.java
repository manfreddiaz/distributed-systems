...
/**
* ca/concordia/encs/distributed/client/corba/model/ClinicServicePOA.java .
...
public abstract class ClinicServicePOA extends org.omg.PortableServer.Servant
 implements ca.concordia.encs.distributed.client.corba.model.ClinicServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // interop/ClinicService/createDRecord
       {
         ...
         ca.concordia.encs.distributed.client.corba.model.Message $result = null;
         $result = this.createDRecord (managerID, firstName, lastName, address, phone, specialization);
         out = $rh.createReply();
         ca.concordia.encs.distributed.client.corba.model.MessageHelper.write (out, $result);
         break;
       }
