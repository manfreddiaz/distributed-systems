...
/**
* ca/concordia/encs/distributed/client/corba/model/_ClinicServiceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ClinicServices.idl
* Monday, July 4, 2016 5:06:05 PM CDT
*/

public class _ClinicServiceStub extends org.omg.CORBA.portable.ObjectImpl implements ca.concordia.encs.distributed.client.corba.model.ClinicService
{

  public ca.concordia.encs.distributed.client.corba.model.Message createDRecord (String managerID, String firstName, String lastName, String address, String phone, String specialization)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                ca.concordia.encs.distributed.client.corba.model.Message $result = ca.concordia.encs.distributed.client.corba.model.MessageHelper.read ($in);
                return $result;
  ...
  public ca.concordia.encs.distributed.client.corba.model.Message createNRecord (String managerID, String firstName, String lastName, String designation, String status, int statusDate)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public ca.concordia.encs.distributed.client.corba.model.Message getRecordCounts (String managerID, String recordType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public ca.concordia.encs.distributed.client.corba.model.Message editRecord (String managerID, String recordID, String fieldName, String newValue)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public ca.concordia.encs.distributed.client.corba.model.Message transferRecord (String managerID, String recordID, String remoteClinicServerName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
